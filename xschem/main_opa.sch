...
N -0 -20 -0 -10 {lab=GND}
N 750 -130 750 -100 {lab=vout}
N 750 -130 770 -130 {lab=vout}
N 600 -110 620 -110 {lab=vcm}
N 600 -110 600 -0 {lab=vcm}
N 600 -0 600 70 {lab=vcm}
N 480 -80 540 -80 {lab=virt}
N 540 -80 620 -80 {lab=virt}
N 620 -90 620 -80 {lab=virt}
...
C {gnd.sym} 680 -20 0 0 {name=l4 lab=GND}
...
C {symb_1.sym} 860 30 0 0 {name=x1}
C {simulator_commands_shown.sym} 0 -570 0 0 {name=COMMANDS
simulator=ngspice
only_toplevel=false 
value="
.op
